...
add('cv-1', {
  ...
  ports: ports([
    ...
    ['cv-1-annulus-1', -DUCT_LENGTH / 2, ANNULUS_NOZZLE_DROP],  // RPV end: cold return out
    ['cv-1-annulus-2', DUCT_LENGTH / 2, ANNULUS_NOZZLE_DROP],   // SG end: circulator discharge in
  ]),
  fluid: heFluid(T_CORE_OUT),
