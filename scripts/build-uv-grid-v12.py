"""
Build (u, v) grid - Version 12.

Compressed liquid: 8 curves with log10(v_offset) increasing at rates that
double at u=1000, 1200, and 1400:
- u=0 to 800: base rate (1.0x to 1.3x)
- u=800 to 1000: 2x rate
- u=1000 to 1200: 4x rate
- u=1200 to 1400: 8x rate
- u>1400: 16x rate

All transitions are continuous (no discontinuities).
"""
...
# Base rate: log10(1.3) / 800 = 0.114 / 800
base_rate = 0.114 / 800
...
def get_log_v_offset(base_log_offset, u):
    ...
    if u <= 800:
        ...
        val_at_800 = base_rate * 800  # = 0.114
...
for u_check in [0, 400, 800, 1000, 1200, 1400, 1600, 1800, 1950]:
...
output = {
    'description': 'Water properties on (u, v) grid - v12 with accelerating log offset',
...
output_path = Path(__file__).parent / 'uv_grid_data_v12.json'
